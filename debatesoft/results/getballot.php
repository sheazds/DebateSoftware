		...
		echo "<td class='ballotstd'>";
			echo "<div id='ballot_speaker".$current_ballot."' class='ballot_speaker'><table class='ballot_inner_table'><tbody>";
				...
				echo "<tr><td style='text-align: center'>Organization/<br />Structure</td>
					<td><form id='orgstruc' onchange='post_ballot(orgstruc, ".$current_ballot.")'>"; ?>
					...
					echo "<tr><td style='text-align: center'>Evidence/<br />Analysis</td>
						<td><form id='evidana' onchange='post_ballot(evidana, ".$current_ballot.")'>"; ?>
					...
					echo "<tr><td style='text-align: center'>Rebuttal/<br />Clash</td>
						<td><form id='rebcla' onchange='post_ballot(rebcla, ".$current_ballot.")'>"; ?>
					...
					echo "<tr><td style='text-align: center'>Delivery/<br />Etiquette</td>
						<td><form id='deleti' onchange='post_ballot(deleti, ".$current_ballot.")'>"; ?>
					...
					echo "<tr><td style='text-align: center'>Questioning/<br />Responding</td>
						<td><form id='questres' onchange='post_ballot(questres, ".$current_ballot.")'>"; ?>
				...
				echo "<tr><td colspan='2'>Comments:</br>
						<textarea rows='4' cols='35' id='comments".$current_ballot."' name='comments' onchange='post_ballot(this.name, ".$current_ballot.", this.value)'>".$row['comments']."</textarea></td>
					<td>Total Score:</br>
					".$score."</td></tr>";
