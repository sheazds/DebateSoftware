...
<body>
	<div class="pageheader">Pairing :: Round Pairings :: Generate Matches</div>
	<div class="body">
		<?php
		...
		<form method="post" action="pairings_generate.php">
			...
			<p style="clear: both">
				...
				<input onclick="window.location='pairings.php?round_id=<?php echo $round['round_id']; ?>'" type="button" value="Cancel" />
			</p>
		</form>
	</div>
</body>
