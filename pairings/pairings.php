		...
		<form>
			<div class="toolbar">
				...
				<?php
					if ($round_id != "") {
				?>
					<a class="toolbar" href="pairings_generate.php?round_id=<?php echo $round['round_id']; ?>">
						Generate Pairings
					</a>
					<a class="toolbar" href="pairings_judges.php?round_id=<?php echo $round_id; ?>">
						Judge Pairings
					</a>
			...
			<table class="reglist">
				...
				?>
						...
						<tr>
							...
							<td class="command">
								<input type="button" onclick="window.location='pairings_delete.php?match_id=<?php echo $match['match_id']; ?>'" value="Delete" />
							</td>
						</tr>
						</form>
				<?php
