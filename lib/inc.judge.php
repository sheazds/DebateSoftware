<?php
	...
	class Judge {
		...
		function get_judges($db) {
			$sql_string = "SELECT * FROM judge ORDER BY judge_name ASC";
			return $db->fetch_rows($sql_string);
		}

		/*function get_active_judges($db) {
			$sql_string = "SELECT * FROM judge WHERE judge_active='1' ORDER BY judge_active DESC, judge_name ASC";
			return $db->fetch_rows($sql_string);
		}
		
		function get_active_judges_by_rank($db) {
			$sql_string = "SELECT * FROM judge WHERE judge_active='1' ORDER BY judge_active DESC, judge_rank ASC, judge_name ASC";
			return $db->fetch_rows($sql_string);
		}*/
